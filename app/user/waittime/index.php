...
$class = "3年1組";
$userid = "fromphp0000000000";

try {
    $pdo = new PDO($dsn, $user, $password);
    $pdo->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $stmt = $pdo->prepare("SELECT AVG(TIMESTAMPDIFF(SECOND, enter, start)) AS avg_waitingtime, AVG(TIMESTAMPDIFF(SECOND, leaving, enter)) AS avg_stayingtime FROM queue ");//FIXME 来なかった人の平均もとっちゃうからWHEREを適切に追加
    $stmt->execute();
